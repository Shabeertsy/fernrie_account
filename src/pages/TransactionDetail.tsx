...
import type { CompanyTransaction, PersonalTransaction, Partner } from '../types';
...
const TransactionDetail: React.FC = () => {
    ...
    const getPersonDisplay = (t: CompanyTransaction) => {
        ...
        if (t.person) {
            if (typeof t.person === 'object') return t.person.name;
        ...
        <div className="space-y-6 pb-24 sm:pb-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <Card className="p-6 bg-white border-slate-100 shadow-sm">
                <div className="flex flex-col items-center text-center mb-6">
                    <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-3 ${transaction.transaction_type === 'income' ? 'bg-emerald-100 text-emerald-600' : 'bg-red-100 text-red-600'
                        }`}>
